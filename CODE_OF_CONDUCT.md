# Pacto de Comportamiento del Pacto del Colaborador
...
Casos de comportamiento abusivo, acosador o inaceptable de otro modo podrán ser reportados a los administradores de la comunidad responsables del cumplimiento a través de **nicolas.baier@uautonoma.cl**.
...
**Consecuencia**: Un aviso por escrito y privado por parte de los administradores de la comunidad, proporcionando claridad sobre la naturaleza de la violación y una explicación del por qué el comportamiento es inaceptable. Una disculpa pública puede ser solicitada.

### 2. Aviso

**Impacto en la Comunidad**: Un incumplimiento causado por un único incidente o por una serie de acciones.
